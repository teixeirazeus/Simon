...
;Heap indices
;Espelha item i no vetor em 0x26
; se zero deixa como estÃ¡ pois o registrador de retorno estÃ¡ zerado, senÃ£o seta o bit correspondente
...
;A partir daqui comeÃ§a o acesso ao registrador alto do vetor
...
getHeap:
;FunÃ§Ã£o para leitura do vetor formado pelos registradores 0x22 e 0x23
;O registrador 0x25 Ã© o argumento para esta funÃ§Ã£o
; como o exemplo: return vetor[0x25] em C
;0x26 Ã© o retorno
	;0x21 = 0x25, salva o argumento
	movf 0x25, 0
	...
	;retorna argumento como ele entrou na funÃ§Ã£o
	movf 0x21, 0
	movwf 0x25
	return
...
main:
	...
	;0x24 Nivel do Jogo comeÃ§a em zero
	clrf 0x24
	...
	loopGame:
		...
		;x27 = 0
		clrf 0x27
		decf 0x27; x27--, correÃ§Ã£o para o loop bot
		...
		bot:
			...
			movlw .0
			subwf 0x26, 0
			btfsc 0x03, 2 ; x26 Ã© igual a zero?			
			call acendeled0		

			;led 1
			movlw .1
			subwf 0x26, 0
			btfsc 0x03, 2 ; x26 Ã© igual a um?			
			call acendeled1	

			;led 2
			movlw .2
			subwf 0x26, 0
			btfsc 0x03, 2 ; x26 Ã© igual a dois?			
			call acendeled2	

			;led 3
			movlw .3
			subwf 0x26, 0
			btfsc 0x03, 2 ; x26 Ã© igual a trÃªs?			
			call acendeled3	
			;ROTINA DE LED FIM
			
			;if x27 - x24 = 0, se x27 jÃ¡ passou por todos os indices do nivel x24
			movf 0x24, 0
			subwf 0x27, 0

		btfss 0x03, 2	;sÃ£o igual?, bit z
		goto bot
		
		;x27 = 0
		clrf 0x27
		decf 0x27; x27--, correÃ§Ã£o para o loop player
		...
		;Confere entradas do jogador
			...
			;x26 == x28?, o jogador apertou o botÃ£o certo?
			movf 0x26, 0
			subwf 0x28, 0

			btfss 0x03, 2	;sÃ£o igual?
			goto gameOver			
			nop	;jogador acertou, continua o loop
		...
		btfss 0x03, 2	;sÃ£o iguai? zerou o jogo
		goto loopGame
...
intext: bcf     0x0b,1      ; Apaga a flag INT EXT. -> RB0 (0x06,0)
        movf    0x0e,0
        movwf   0x22        ;0x20 = tmr1Low
 
        movf    0x0f,0
        movwf   0x23        ;0x21 = tmr1High
